    ...
    try:
        ...
        with engine.begin() as conn:
            ...
            df_paciente = df.drop_duplicates(subset=['DNI_paciente']).rename(columns={
                ...
                'Direccion_paciente_barrio': 'Direccion_paciente_barrio', 
                'Direccion_paciente_ciudad': 'Direccion_paciente_ciudad', 
                'Direccion_paciente_provincia': 'Direccion_paciente_provincia',
            })
            
            df_paciente = df_paciente.merge(
                df_dir_ids,
                left_on=['Direccion_paciente_barrio', 'Direccion_paciente_ciudad', 'Direccion_paciente_provincia'],
